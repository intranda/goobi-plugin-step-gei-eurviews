...
public class WorldViewsDatabaseManager {
    ...
    private static final String COLUMN_CONTRIBUTIONESCRIPTION_PUBLICATIONYEARDIGITAL = "publicationYearDigital";
    ...
    public static List<NormdataEntity> getNormData(int metadataId) throws SQLException {
        ...
        try {
            ...
            List<NormdataEntity> ret = new QueryRunner().query(connection, sql.toString(), WorldViewsDatabaseManager.resultSetToNormDataListHandler);
            return ret;
        } finally {
            if (connection != null) {
                MySQLHelper.closeConnection(connection);
    ...
    private static ResouceMetadata convertResourceMetadata(ResultSet rs) throws SQLException {
        ...
        data.setPublicationYearDigital(rs.getString(COLUMN_RESOURCE_PUBLICATIONYEARDIGITAL));
    ...
    private static ResultSetHandler<List<NormdataEntity>> resultSetToNormDataListHandler = new ResultSetHandler<List<NormdataEntity>>() {
        @Override
        public List<NormdataEntity> handle(ResultSet rs) throws SQLException {
            try {
                List<NormdataEntity> answer = new ArrayList<>();
                while (rs.next()) {
                    NormdataEntity nd = new NormdataEntity(rs.getString(COLUMN_NORMDATA_AUTHORITY));

                    nd.setUri(rs.getString(COLUMN_NORMDATA_URI));
                    nd.setId(rs.getString(COLUMN_NORMDATA_VALUE));
                    answer.add(nd);
                }
                return answer;
            } finally {
    ...
    private static ResultSetHandler<List<ComplexMetadataObject>> resultSetToComplexMetadataListHandler =
            new ResultSetHandler<List<ComplexMetadataObject>>() {
                @Override
    ...
    public static void saveContribtutionDescription(AnnotationMetadata plugin) throws SQLException {
        ...
        try {
            ...
            if (plugin.getId() == null) {
                ...
                sql.append(", ");
                sql.append(COLUMN_CONTRIBUTIONESCRIPTION_PUBLICATIONYEARDIGITAL);
                sql.append(", ");
    ...
    public static void getContributionDescription(AnnotationMetadata plugin) throws SQLException {
        ...
        try {
            ...
            if (!ret.isEmpty()) {
                ...
                plugin.setPublicationYearDigital(ret.get(COLUMN_CONTRIBUTIONESCRIPTION_PUBLICATIONYEARDIGITAL));
    ...
    public static void saveResouceMetadata(ResouceMetadata data) throws SQLException {
        ...
        try {
            ...
            if (data.getId() == null) {
                ...
                sql.append(", ");
                sql.append(COLUMN_RESOURCE_PUBLICATIONYEARDIGITAL);
                sql.append(", ");
        ...
        public ResouceMetadata handle(ResultSet rs) throws SQLException {
            try {
                ...
                if (rs.next()) {
                    ...
                    metadata.setPublicationYearDigital(rs.getString(COLUMN_RESOURCE_PUBLICATIONYEARDIGITAL));
